...
<html>
    <head>
        ...
        <title><fmt:message key="perfil.titulo"/></title>
    </head>
            ...
            <div class="perfil-detalles">
                <form action="${sessionScope.ContextPath}/perfil/editarperfil" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="inputs-perfil">
                        ...
                        <label>
                            <strong><fmt:message key="perfil.label.email"/></strong> <input type="text" id="email" name="email" value="${requestScope.redactor.email}" disabled="true"/>
                        </label>
                        <label>
                            <strong><fmt:message key="perfil.label.dni"/></strong> <input type="text" id="dni" name="dni" value="${requestScope.redactor.dni}" disabled="true"/>
                        </label>
                        <label>
                            <strong><fmt:message key="perfil.label.pwdantigua"/> </strong><input type="password" id="pwdantigua" name="pwdantigua" disabled="true" />
                        </label>
                        <label>
                            <strong><fmt:message key="perfil.label.pwdnueva"/></strong><input type="password" id="pwdnueva" name="pwdnueva" disabled="true"/>
                        </label>
                    ...
                    <button type="submit" class="btn btn-success editar-perfil" style="margin: 1rem; display: none" id="guardarPerfil">
                        ...
                        <fmt:message key="perfil.guardar" />
                    </button>
                </form>
                <button class="btn btn-danger editar-perfil" style="margin: 1rem; display: none" id="cancelarPerfil" onclick="location.reload()">
                    ...
                    <fmt:message key="perfil.cancelar" />
                </button>
